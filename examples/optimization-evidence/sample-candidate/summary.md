...
|---|---|---|---|---|---|
| OPT-001 | P1 | component-cache | candidate | OPT-001-finding.md | заполнить evidence |
| OPT-002 | P2 | tagged-cache | candidate | OPT-002-finding.md | заполнить evidence |
