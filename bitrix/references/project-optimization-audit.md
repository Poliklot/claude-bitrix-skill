...
- Component lifecycle/cache — [components.md](components.md), [templates.md](templates.md), [frontend-assets-performance.md](frontend-assets-performance.md)
- Видимость данных и индексы — [index-cache-diagnostics.md](index-cache-diagnostics.md), [seo-cache-access.md](seo-cache-access.md)
- SQL/ORM — [db-orm-performance.md](db-orm-performance.md), [database-layer.md](database-layer.md), [orm.md](orm.md), [iblocks.md](iblocks.md)
- Performance diagnostics — [perfmon.md](perfmon.md)
- Agents/imports/operations — [agents-imports-performance.md](agents-imports-performance.md), [operations-runbook.md](operations-runbook.md), [update-stepper.md](update-stepper.md), [import-export.md](import-export.md)
- Shop performance — [shop-performance.md](shop-performance.md), [catalog.md](catalog.md), [sale.md](sale.md), [shop-standard-components.md](shop-standard-components.md)
